...
🇱🇰😊 Wellcome Channel Auto Post Menu And Interface. Send Me  /postStart  
    ...
    [
        ...
        [
            ...
            InlineKeyboardButton(
                ...
                '🌹 Channel 🌹', url='https://telegram.me/CatXGirlNews'),

            InlineKeyboardButton(

                '💙 Feedback 💙', url='https://telegram.me/CatXGirlSupport')
        ...
        [
            ...
            InlineKeyboardButton(
                ...
                '🧩 Source Code 🧩', url='https://github.com/RishbroProMax/member-counter-Bot/')
...
@Bot.on_message(filters.private & filters.command("/postStart"))
